...
namespace Midterm
{
    class VendingMachine : IEnumerable<VendingMachineOption>
    {
        ...
        //The other solutions should also work, assuming this portion would work.
         IEnumerable<VendingMachineOption>[,] options = new VendingMachineOption[5,4];
        ...
        public IEnumerable<VendingMachineOption> this[int x, int y]
        {
            get { return options[x, y]; }
        }

        //Changed to an enumerable to match the variables.
        public void PrintVendingMachine(IEnumerable<VendingMachineOption> exclusions)
        {
            Console.WriteLine();
